...
fun CreateTaskScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(text = "Создать задачу", fontWeight = FontWeight.Bold)
                },
                navigationIcon = {
                    IconButton(onClick = {
                        focusManager.clearFocus()
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                onValueChange = {
                    viewModel.onEvent(CreateTaskEvent.ChangeTitle(it.take(maxTextTitle)))
                },
            ...
            Row(
                ...
                BasicTextField(
                    ...
                    onValueChange = {
                        viewModel.onEvent(CreateTaskEvent.ChangeCountPrice(it.take(maxCharPrice)))
                    },
                    textStyle = LocalTextStyle.current.copy(
